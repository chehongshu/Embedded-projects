...
#define Encoder_BM 360	//编码器每圈脉冲数
#define Encoder_A  GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_4)//读取A相电平状态
#define Encoder_B  GPIO_ReadInputDataBit(GPIOA,GPIO_Pin_3)//读取B相电平状态
